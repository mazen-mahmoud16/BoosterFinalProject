...
class AwarenessRoom : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dataaAdapter=LessonAdapter(this,getLessonList())
    ...
    private fun getLessonList() : ArrayList<Lesson> {
        ...
        LessonList.add(Lesson("Support System", "Lesson 1", "Building an integral support system,\n" +
                "Pushes you to grow, strech more, mainly asks why things wont work, and bullet proofs ideas","Start"))
        LessonList.add(Lesson("Support System", "Lesson 2", "These generic visual supports templates " +
                "will be a gamechanger for you and your students this comprehensive set is perfect for you!","Locked"))
        LessonList.add(Lesson("Support System", "Lesson 3", "If you are looking for a fun and " +
                "innovative way to motivate your students to improve their handwriting, their skills and their abilities! ","Locked"))
        LessonList.add(Lesson("Support System", "Lesson 4", "Understanding who you can count on is a key social and emotional " +
                "skill we can teach early and reinforce through high school.","Locked"))
        LessonList.add(Lesson("Support System", "Lesson 5", "These generic visual supports templates " +
                "will be a gamechanger for you and your students this comprehensive set is perfect for you!","Locked"))
        LessonList.add(Lesson("Support System", "Lesson 1 Quiz", "Good Luck","Start Quiz"))
        LessonList.add(Lesson("Support System", "Lesson 2 Quiz", "Good Luck","Start Quiz"))
        LessonList.add(Lesson("Support System", "Lesson 3 Quiz", "Good Luck","Start Quiz"))
        LessonList.add(Lesson("Support System", "Lesson 4 Quiz", "Good Luck","Start Quiz"))
        LessonList.add(Lesson("Support System", "Lesson 5 Quiz", "Good Luck","Start Quiz"))
        LessonList.add(Lesson("Support System", "Finished", "Thanks for finishing the lesson and " +
